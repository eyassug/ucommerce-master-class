...
namespace MyUCommerceApp.Website.Controllers
{
	public class MasterClassShippingController : Umbraco.Web.Mvc.RenderMvcController
    {
        public ActionResult Index()
        {
	        ...
	        UCommerce.EntitiesV2.OrderAddress shippingInfomation = TransactionLibrary.GetShippingInformation();

	        ICollection<ShippingMethod> availableShippingMethods =
		        TransactionLibrary.GetShippingMethods(shippingInfomation.Country);
